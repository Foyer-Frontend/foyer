...
constexpr Catalogue kEnglishStrings = [] {
    ...
    a[(std::size_t)StringId::DisplayRoundedTiles]        = "Rounded tiles";
    a[(std::size_t)StringId::DisplayRoundedTilesHint]    = "Soften the system carousel tiles' corners.";
    a[(std::size_t)StringId::DisplayActionRowDock]       = "Action row dock";
    a[(std::size_t)StringId::DisplayActionRowDockHint]   = "Wrap the home action buttons in a single rounded dock pill.";
