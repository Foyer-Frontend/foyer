...
const std::array<const char*, kCount> kSpanishStrings = [] {
    ...
    a[(std::size_t)StringId::DisplayRoundedTiles]        = "Bordes redondeados";
    a[(std::size_t)StringId::DisplayRoundedTilesHint]    = "Suaviza las esquinas de las casillas del carrusel.";
    a[(std::size_t)StringId::DisplayActionRowDock]       = "Dock de acciones";
    a[(std::size_t)StringId::DisplayActionRowDockHint]   = "Agrupa los botones del Home en una sola píldora redondeada.";
